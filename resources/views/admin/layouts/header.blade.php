<!-- Navbar -->
<nav class="main-header navbar navbar-expand navbar-{{(request()->is('admin/dashboard')?'light':'light')}}">
    <!-- Left navbar links -->
    <ul class="navbar-nav">
        <li class="nav-item">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{route('admin.profile')}}" class="nav-link {{(request()->is('admin/profile')?'active':'')}}">Profile</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
